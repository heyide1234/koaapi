...
const controller = require("../../../controller/api/apiModel/transactions");
...
//事务
router.get("/apiModel/transactions", controller.transactions);
router.get("/apiModel/getsesstionsId", controller.getsesstionsId);
