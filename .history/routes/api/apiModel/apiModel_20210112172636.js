...
const controllers = require("../../../controller/api/apiModel/transactions");
...
//事务
router.get("/apiModel/transactions", controllers.transactions);
router.get("/apiModel/getsesstionsId", controllers.getsesstionsId);
