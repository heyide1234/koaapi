...
async function addMeterial(datas) {
    for (let i = 0; i < datas.length; i++) {
        this.$delete(datas, "_id");
        datas.status = "0";
        await this.$https({
    ...
    getProcessState(orderNumber, "MaterialDemand", "3");

}
function getProcessState(orderNumber, table, processCode) {
